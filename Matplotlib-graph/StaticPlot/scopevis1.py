...
skip = 2 * 0x400 
data_points = skip + 20 * 0x400  #changes...29-4-24
...
ch2_data, _ = scope.read_data(data_points,raw=True)#,raw=True)#timeout=1)
#print(len(ch2_data))
voltage_data = scope.scale_read_data(ch2_data[skip:], voltage_range)
#print(len(voltage_data))
fvoltage_data = fft(voltage_data)
#print(len(fvoltage_data))
#print(voltage_data[90112])
...
pylab.plot(timing_data, fvoltage_data)
